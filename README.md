...
We have identified **260** clusters of industrial witches (clusters with a node size greater than 20).   
Among them, there are **51** witch clusters with node sizes **greater than or equal to 200**. Detailed information can be found in this folder.   
